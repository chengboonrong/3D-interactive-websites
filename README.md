...
**543 KB on disk / 142 KB gzipped** (118 KB brotli). A two-second 1080p H.264 clip is larger.
...
aberration, vignette, grain. Nine passes, ~4 KB of GLSL, and it tree-shakes to
nothing beyond the core renderer.
...
**Resolution adapts.** Rendering starts at DPR 1.35, drops toward 0.75 after
sustained slow frames, and climbs back to 1.75 once the frame timer has been
comfortable for four seconds.
